...
const StartScreen = ({ playerName, setPlayerName, onStart, leaderboard }: Props) => {
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
      ...
      <p className="text-gray-600 mb-8 text-lg">Test your knowledge across various topics!</p>
      ...
      {leaderboard.length > 0 && (
        <LeaderboardPreview leaderboard={leaderboard.slice(0, 5)} />
      )}
    </div>
  );
};
